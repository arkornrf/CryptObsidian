...
> Тип заметки: `hub`  
> Уровень: `must know`  
> Роль в системе: мост между [[Product Thinking]] и [[UX+UI]], который помогает понять **что именно нужно проектировать**, **для кого**, **почему** и **на основании каких данных**.
...
- [[UX+UI]] помогает превратить это в понятный опыт;
